...
const string strMessageMagic = "DarkCash Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DarkCash", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1406282900;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1061744;
		if(fTestNet)
        {
            block.nNonce   = 1061744;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xa980d2ab0cee949d3ac21f7af8d99ea47e13699992ad7be8320f077e906c7507"));
        block.print();
